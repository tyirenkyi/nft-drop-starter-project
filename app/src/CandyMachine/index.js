        ...
        async (notification, context) => {
          if (notification.type === 'status') {
            ...
            if (!result.err) {
              ...
              setIsMinting(false)
              toast.success('NFT Minted! You can check your wallet.')
            }
          }
        },
    ...
    <div className="machine-container">
      ...
      {machineStats && machineStats.itemsRedeemed === machineStats.itemsAvailable ? (
        ...
        <>
          {isMinting ? (
            <img 
              src={'https://media0.giphy.com/media/OgAzOhmmjj94wVyJ6Z/giphy.gif?cid=ecf05e47aq5o0gewldvzfrwsmhgzrgll4jjruc5kje9bie3k&rid=giphy.gif&ct=g'}
              alt=""
              style={{width: '150px', margin: 'auto'}}
            />
          ) : (
            <button className="cta-button mint-button" style={{width: '200px', margin: 'auto'}} onClick={mintToken}>
              Mint NFT
            </button>
          )}
        </>
